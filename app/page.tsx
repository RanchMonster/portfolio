...
import { getUserStats, getRecentActivity, GithubEvent } from "@/lib/github-stats";
...
export default async function Home() {
   ...
   return (
      <main className="flex-1 flex flex-col px-4">
         ...
         <section className="w-full max-w-4xl mx-auto pb-16 animate-[fadeInUp_0.65s_ease-out]">
            ...
            <p className="text-xs text-text-muted mt-2 font-mono text-center">
               182 contributions in 2026
            </p>
         </section>
